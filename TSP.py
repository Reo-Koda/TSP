...
def print_result_only(tour, length_cashe, text):
    print(f"{ text }", end=' ')
...
# tour = print_result_only(tour, length_cache, "rand_ci")
# tour = Gready.many_ci(city_list, tour, length_cache)
# tour = print_result_only(tour, length_cache, "many_ci")
# tour = GA.GA(
#     city_list,
#     length_cache,
#     neighbors_rank,
...
tour = ILS.ILS(city_list, tour, length_cache, neighbors_rank, rank, minuites=5, interval=50)
